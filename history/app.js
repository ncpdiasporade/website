(() => {
  ...
  const DATA_URL = 'archive-data.json?v=20260828-archive-v3';
  ...
  const COPY = {
    bn: {
      ...
      heroKicker: 'রাষ্ট্রযন্ত্রকে দমনযন্ত্রে পরিণত করার প্রমাণ', heroLineOne: 'হাসিনার ১৬ বছরের শাসন', heroLineTwo: 'গুম, রক্ত ও ভয় দিয়ে ক্ষমতা আঁকড়ে রাখার নথি',
      ...
      patternsLabel: 'শাসনের প্রমাণচিত্র', patternsTitle: 'একটি ঘটনা নয়—১৬ বছর ধরে জমে ওঠা দমনের কাঠামো', patternsIntro: 'বছর, বিষয় ও প্রমাণের শক্তি একসঙ্গে দেখলে ছবিটি পরিষ্কার: গুম, পুলিশি সহিংসতা, মতপ্রকাশ দমন এবং নির্বাচন সংকোচন ক্ষমতা ধরে রাখার পুনরাবৃত্ত পদ্ধতি হয়ে উঠেছিল। কোনো বার বা বিভাগে ক্লিক করলে সংশ্লিষ্ট নথি খুলবে।', fallCaption: '৫ আগস্ট ২০২৪—গণআন্দোলনের মুখে হাসিনার ক্ষমতার পতন', verdictLabel: 'আর্কাইভের সিদ্ধান্ত', verdictTitle: 'জুলাই ছিল বিস্ফোরণ; তার পেছনে ছিল ১৬ বছরের জমে থাকা দমন', verdictBody: 'OHCHR জুলাই–আগস্টের সহিংসতায় সাবেক সরকার, নিরাপত্তা ও গোয়েন্দা সংস্থা এবং আওয়ামী লীগ-সংশ্লিষ্ট সহিংস উপাদানের পদ্ধতিগত গুরুতর মানবাধিকার লঙ্ঘনের সম্পৃক্ততা নথিভুক্ত করেছে। এই আর্কাইভ দেখায়, সেই চূড়ান্ত দমন হঠাৎ তৈরি হয়নি—গুম, বিচারবহির্ভূত হত্যা, বিরোধী দমন ও ভোটাধিকার হরণের দীর্ঘ ধারাই জুলাইয়ে বিস্ফোরিত হয়েছিল।', timelineLabel: 'সময়ভিত্তিক চাপ', timelineTitle: 'কোন বছরে কত নথি', categoryChartLabel: 'দমনের ধরন', categoryChartTitle: 'সবচেয়ে পুনরাবৃত্ত প্যাটার্ন', evidenceChartLabel: 'প্রমাণের শক্তি', evidenceChartTitle: 'উৎস কতটা দৃঢ়', evidenceChartNote: 'A = শক্ত প্রাথমিক/জাতিসংঘ/বহু-উৎস প্রমাণ; B = বিশ্বাসযোগ্য নথি, কিছু দায় অমীমাংসিত; C = সতর্কতার সঙ্গে পাঠযোগ্য অভিযোগ বা অসম্পূর্ণ তথ্য।', chartRecords: 'নথি', visualEvidence: 'প্রাসঙ্গিক প্রমাণচিত্র', storyTitle: 'প্রথমবার পড়লে—ঘটনাটির অর্থ', patternCount: 'একই প্যাটার্নে', yearCount: 'এই বছরে', imageContext: 'ছবিটি এই ঘটনা/বিষয়ের প্রাসঙ্গিক প্রমাণচিত্র; প্রতিটি ক্ষেত্রে নির্দিষ্ট মুহূর্তের ছবি নাও হতে পারে।',
    ...
    en: {
      ...
      heroKicker: 'Evidence of a state apparatus turned into machinery of repression', heroLineOne: 'Hasina’s 16-year rule', heroLineTwo: 'A record of clinging to power through disappearance, bloodshed and fear',
      ...
      patternsLabel: 'Evidence map of the regime', patternsTitle: 'Not one incident—a structure of repression built over 16 years', patternsIntro: 'Viewed by year, category and evidence strength, the pattern is unmistakable: disappearance, police violence, repression of expression and the hollowing-out of elections became recurring methods of holding power. Select any bar or category to open the linked records.', fallCaption: '5 August 2024—Hasina’s rule falls before a mass uprising', verdictLabel: 'Archive conclusion', verdictTitle: 'July was the eruption; behind it lay 16 years of accumulated repression', verdictBody: 'OHCHR documented systematic serious human-rights violations involving the former government, security and intelligence agencies, and violent elements associated with the Awami League during July–August. This archive shows that the final crackdown did not appear from nowhere: a long record of disappearance, extrajudicial killing, opposition repression and stolen voting rights culminated in July.', timelineLabel: 'Pressure over time', timelineTitle: 'Records by year', categoryChartLabel: 'Forms of repression', categoryChartTitle: 'Most repeated patterns', evidenceChartLabel: 'Strength of evidence', evidenceChartTitle: 'How robust are the sources?', evidenceChartNote: 'A = strong primary, UN or multi-source evidence; B = credible documentation with some attribution unresolved; C = allegations or incomplete information that require caution.', chartRecords: 'records', visualEvidence: 'Relevant evidence image', storyTitle: 'If this is your first reading—what the incident means', patternCount: 'Same pattern', yearCount: 'This year', imageContext: 'This is an evidentiary image relevant to the incident or subject; it may not depict the exact moment in every case.',
    ...
    de: {
      ...
      heroKicker: 'Belege für einen zum Repressionsapparat umgebauten Staat', heroLineOne: 'Hasinas 16-jährige Herrschaft', heroLineTwo: 'Das Protokoll des Machterhalts durch Verschwindenlassen, Blut und Angst',
      ...
      patternsLabel: 'Beweiskarte des Regimes', patternsTitle: 'Kein Einzelfall—eine über 16 Jahre aufgebaute Struktur der Repression', patternsIntro: 'Nach Jahr, Kategorie und Belegstärke betrachtet ist das Muster eindeutig: Verschwindenlassen, Polizeigewalt, Unterdrückung der Meinungsfreiheit und ausgehöhlte Wahlen wurden zu wiederkehrenden Methoden des Machterhalts. Wählen Sie einen Balken oder eine Kategorie, um die zugehörigen Einträge zu öffnen.', fallCaption: '5. August 2024—Hasinas Herrschaft fällt vor einem Massenaufstand', verdictLabel: 'Schlussfolgerung des Archivs', verdictTitle: 'Der Juli war die Eruption; dahinter standen 16 Jahre aufgestauter Repression', verdictBody: 'Das OHCHR dokumentierte für Juli und August systematische schwere Menschenrechtsverletzungen unter Beteiligung der ehemaligen Regierung, von Sicherheits- und Geheimdiensten sowie gewalttätigen, mit der Awami League verbundenen Akteuren. Dieses Archiv zeigt: Die letzte Niederschlagung entstand nicht plötzlich; Verschwindenlassen, außergerichtliche Tötungen, Oppositionsunterdrückung und geraubte Wahlrechte mündeten im Juli.', timelineLabel: 'Druck im Zeitverlauf', timelineTitle: 'Einträge nach Jahr', categoryChartLabel: 'Formen der Repression', categoryChartTitle: 'Am häufigsten wiederkehrende Muster', evidenceChartLabel: 'Belegstärke', evidenceChartTitle: 'Wie belastbar sind die Quellen?', evidenceChartNote: 'A = starke Primär-, UN- oder Mehrquellenbelege; B = glaubwürdige Dokumentation mit teils offener Zuordnung; C = Vorwürfe oder unvollständige Angaben, die Vorsicht erfordern.', chartRecords: 'Einträge', visualEvidence: 'Relevantes Beweisbild', storyTitle: 'Beim ersten Lesen—was der Vorfall bedeutet', patternCount: 'Gleiches Muster', yearCount: 'In diesem Jahr', imageContext: 'Das Bild ist für den Vorfall oder das Thema relevant; es zeigt nicht in jedem Fall den exakten Moment.',
