(() => {
  ...
  const en = {
    ...
    'ব্লগ ও বিশ্লেষণ': 'Blog & analysis',
    'প্রশ্ন করি, তথ্য খুঁজি, সহজ ভাষায় বুঝি': 'Ask the question. Follow the evidence. Explain it clearly.',
    'বাংলাদেশ ও প্রবাসজীবনের যেসব সিদ্ধান্ত আমাদের সরাসরি প্রভাবিত করে, সেগুলো আমরা নথি, তথ্য ও সহজ ভাষায় খতিয়ে দেখি। এখানে আছে রাজনৈতিক জবাবদিহি, জুলাইয়ের রাষ্ট্রচিন্তা, প্রবাসী অধিকার, অর্থনীতি এবং জার্মানি–বাংলাদেশ সংযোগ নিয়ে বিশ্লেষণ।': 'We examine the decisions that directly affect Bangladesh and diaspora life through public records, evidence and clear language. The section covers political accountability, the unfinished state-building agenda of July, diaspora rights, the economy and Germany–Bangladesh relations.',
    'আপনার কাছে কি এমন কোনো প্রশ্ন, অভিজ্ঞতা বা তথ্য আছে যা জনসমক্ষে আসা দরকার? প্রমাণ ও প্রাসঙ্গিক সূত্রসহ লিখে পাঠান। সম্পাদকীয় যাচাইয়ের পর নির্বাচিত লেখা প্রকাশ করা হবে।': 'Do you have a question, experience or evidence that deserves public attention? Send us a draft with relevant sources. Selected submissions will be published after editorial verification.',
    'লেখা পাঠান': 'Submit an article',
    'সম্পূর্ণ লেখা পড়ুন': 'Read full article',
    'আরও দেখুন': 'More',
    'সব আপডেট দেখুন': 'View all six updates',
    ...
    'নিজস্ব জুলাই আর্কাইভ': 'NCPDA July archive',
    'July Uprising 2024: পূর্ণাঙ্গ দলিল ও টাইমলাইন': 'July Uprising 2024: complete record and timeline',
    'জুলাই গণঅভ্যুত্থানের ঘটনাপ্রবাহ, রাষ্ট্রীয় দমন-পীড়ন, ছাত্র-জনতার প্রতিরোধ, প্রবাসীদের ভূমিকা এবং পরবর্তী রাজনৈতিক যাত্রা—বাংলা, ইংরেজি ও জার্মান ভাষায় জানুন।': 'Explore the course of the July Uprising, state repression, student–citizen resistance, the diaspora’s role and the political journey that followed—in Bangla, English and German.',
    'পূর্ণাঙ্গ ইতিহাস জানুন →': 'Explore the full history →',
  ...
  const de = {
    ...
    'ব্লগ ও বিশ্লেষণ': 'Blog & Analyse',
    'প্রশ্ন করি, তথ্য খুঁজি, সহজ ভাষায় বুঝি': 'Fragen stellen. Belege prüfen. Klar erklären.',
    'বাংলাদেশ ও প্রবাসজীবনের যেসব সিদ্ধান্ত আমাদের সরাসরি প্রভাবিত করে, সেগুলো আমরা নথি, তথ্য ও সহজ ভাষায় খতিয়ে দেখি। এখানে আছে রাজনৈতিক জবাবদিহি, জুলাইয়ের রাষ্ট্রচিন্তা, প্রবাসী অধিকার, অর্থনীতি এবং জার্মানি–বাংলাদেশ সংযোগ নিয়ে বিশ্লেষণ।': 'Wir prüfen Entscheidungen, die Bangladesch und das Leben in der Diaspora unmittelbar betreffen – anhand öffentlicher Dokumente, belastbarer Informationen und in verständlicher Sprache. Im Mittelpunkt stehen politische Rechenschaft, der unerledigte Staatsumbau nach dem Juli, Diaspora-Rechte, Wirtschaft und die Beziehungen zwischen Deutschland und Bangladesch.',
    'আপনার কাছে কি এমন কোনো প্রশ্ন, অভিজ্ঞতা বা তথ্য আছে যা জনসমক্ষে আসা দরকার? প্রমাণ ও প্রাসঙ্গিক সূত্রসহ লিখে পাঠান। সম্পাদকীয় যাচাইয়ের পর নির্বাচিত লেখা প্রকাশ করা হবে।': 'Haben Sie eine Frage, Erfahrung oder Belege, die öffentlich diskutiert werden sollten? Senden Sie uns einen Entwurf mit relevanten Quellen. Ausgewählte Beiträge erscheinen nach redaktioneller Prüfung.',
    'লেখা পাঠান': 'Beitrag einreichen',
    'সম্পূর্ণ লেখা পড়ুন': 'Vollständigen Beitrag lesen',
    'আরও দেখুন': 'Mehr anzeigen',
    'সব আপডেট দেখুন': 'Alle sechs Meldungen anzeigen',
    ...
    'নিজস্ব জুলাই আর্কাইভ': 'NCPDA-Juli-Archiv',
    'July Uprising 2024: পূর্ণাঙ্গ দলিল ও টাইমলাইন': 'Juli-Aufstand 2024: vollständige Dokumentation und Chronologie',
    'জুলাই গণঅভ্যুত্থানের ঘটনাপ্রবাহ, রাষ্ট্রীয় দমন-পীড়ন, ছাত্র-জনতার প্রতিরোধ, প্রবাসীদের ভূমিকা এবং পরবর্তী রাজনৈতিক যাত্রা—বাংলা, ইংরেজি ও জার্মান ভাষায় জানুন।': 'Entdecken Sie den Verlauf des Juli-Aufstands, staatliche Repression, den Widerstand von Studierenden und Bevölkerung, die Rolle der Diaspora sowie die anschließende politische Entwicklung—auf Bangla, Englisch und Deutsch.',
    'পূর্ণাঙ্গ ইতিহাস জানুন →': 'Die vollständige Geschichte entdecken →',
