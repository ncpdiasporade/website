(() => {
  ...
  const en = {
    ...
    'স্মৃতি-যাত্রার সময়রেখা': 'Timeline of remembrance',
    'শাসনের শুরু': 'Rule begins',
    'পিলখানা': 'Pilkhana',
    'ফেলানী': 'Felani',
    'ইলিয়াস': 'Ilias Ali',
    'শাপলা': 'Shapla Chattar',
    'আবরার': 'Abrar Fahad',
    'জুলাই গণঅভ্যুত্থান': 'July Uprising',
    '২০০৯ · রাষ্ট্রীয় নিরাপত্তা': '2009 · National security',
    'পিলখানা হত্যাকাণ্ড': 'Pilkhana massacre',
    'বিডিআর বিদ্রোহে ৭৪ জন নিহত হন, তাঁদের মধ্যে ৫৭ জন সেনা কর্মকর্তা। পূর্ণ সত্য ও জবাবদিহির প্রশ্ন আজও গুরুত্বপূর্ণ।': 'Seventy-four people were killed in the BDR mutiny, including 57 army officers. Establishing the full truth and accountability remains essential.',
    '২০২৫ · রাজনৈতিক সহিংসতা': '2025 · Political violence',
    'ওসমান হাদী হত্যাকাণ্ড': 'Killing of Osman Hadi',
    'তরুণ রাজনৈতিক কর্মী ওসমান হাদীর হত্যাকাণ্ড রাজনৈতিক সহিংসতা, নিরাপত্তা ও জবাবদিহির প্রশ্ন সামনে আনে।': 'The killing of young political activist Osman Hadi raises urgent questions about political violence, security and accountability.',
    'ফেলানী হত্যাকাণ্ড': 'Killing of Felani',
    'সীমান্তের কাঁটাতারে ফেলানী খাতুনের মরদেহ ঝুলে থাকা বাংলাদেশের বিবেককে নাড়া দেয়।': 'The sight of Felani Khatun’s body hanging from the border fence shook Bangladesh’s conscience.',
    'ইলিয়াস আলী নিখোঁজ': 'Disappearance of Ilias Ali',
    'গাড়ি পাওয়া গেল, মানুষ ফিরলেন না—গুমের অভিযোগে একটি পরিবারের অপেক্ষা আজও শেষ হয়নি।': 'His car was found, but he never returned—the family’s wait amid allegations of enforced disappearance continues.',
    '২০১৩ · রাষ্ট্রীয় অভিযান': '2013 · State operation',
    'শাপলা চত্বর': 'Shapla Chattar',
    'রাতের অভিযানের হতাহতের সংখ্যা নিয়ে মতভেদ আছে; স্বাধীন পূর্ণাঙ্গ তদন্তের দাবি রয়ে গেছে।': 'Accounts of casualties from the overnight operation differ; the demand for a full, independent investigation remains.',
    '২০১২ · রাজনৈতিক সহিংসতা': '2012 · Political violence',
    'রাজনৈতিক সংঘর্ষের মধ্যে তরুণ দর্জি বিশ্বজিৎ দাস নিহত হন; মামলায় আদালতের দণ্ডও হয়েছিল।': 'Young tailor Biswajit Das was killed amid political clashes; courts later handed down convictions in the case.',
    'আবরার ফাহাদ হত্যাকাণ্ড': 'Killing of Abrar Fahad',
    'একজন শিক্ষার্থীর প্রশ্নের জবাবে দলীয় সহিংসতা—আদালতের দণ্ডের পরও ক্যাম্পাস নিরাপত্তার প্রশ্ন জাগে।': 'Partisan violence answered a student’s questions; despite court convictions, the case still raises concerns about campus safety.',
    '২০২৪ · গণঅভ্যুত্থান': '2024 · Mass uprising',
    'ছাত্র-জনতার আন্দোলনে রাষ্ট্রীয় দমন, গুলি ও গণগ্রেপ্তারের বিরুদ্ধে মানুষ রাস্তায় দাঁড়ায়।': 'Students and citizens took to the streets against state repression, shootings and mass arrests.',
    'একটি সরকারের দীর্ঘ ছায়া; বহু মানুষের অসমাপ্ত ন্যায়বিচার।': 'One government’s long shadow; justice unfinished for many.',
    'ঘটনার তারিখ, ক্ষয়ক্ষতি, তদন্তের অবস্থা, আদালতের রেকর্ড ও উৎস—সব এক জায়গায়। অনিশ্চিত দাবি আলাদা করে চিহ্নিত করা হয়েছে।': 'Dates, losses, investigation status, court records and sources are brought together in one place. Unverified claims are clearly identified.',
    'সম্পূর্ণ ইতিহাস দেখুন': 'View the complete history',
    'শহীদ হাদি': 'Shaheed Hadi',
    '২০১১ · সীমান্ত হত্যা': '2011 · Border killing',
    'ফেলানী খাতুন ও সীমান্ত হত্যা': 'Felani Khatun and border killings',
    '৭ জানুয়ারি ১৫ বছর বয়সী ফেলানী খাতুন বিএসএফের গুলিতে নিহত হন; কাঁটাতারে ঝুলে থাকা তাঁর মরদেহ সীমান্তে প্রাণের অধিকার ও বিচারহীনতার প্রতীক হয়ে আছে।': 'On 7 January, 15-year-old Felani Khatun was shot dead by India’s BSF. Her body hanging from the border fence became a symbol of the right to life and the absence of justice at the border.',
    '২০১৯ · ক্যাম্পাস সহিংসতা': '2019 · Campus violence',
    'আবরার ফাহাদ হত্যা': 'Killing of Abrar Fahad',
    '৬ অক্টোবর বুয়েটের শিক্ষার্থী আবরার ফাহাদকে ছাত্রলীগের নেতা-কর্মীরা পিটিয়ে হত্যা করে। বিচারিক আদালত ২০ জনকে মৃত্যুদণ্ড ও ৫ জনকে যাবজ্জীবন কারাদণ্ড দেয়।': 'On 6 October, BUET student Abrar Fahad was beaten to death by Chhatra League leaders and activists. The trial court sentenced 20 people to death and five to life imprisonment.',
    'শাপলা চত্বর অভিযান': 'Shapla Chattar operation',
    '৫–৬ মে রাতের অভিযানে বলপ্রয়োগ ও প্রাণহানির ঘটনা ঘটে। নিহতের সংখ্যা নিয়ে ভিন্ন তথ্য থাকায় স্বচ্ছ, স্বাধীন তদন্ত এবং পূর্ণাঙ্গ নামের তালিকার দাবি আজও গুরুত্বপূর্ণ।': 'The overnight operation of 5–6 May involved the use of force and loss of life. Because casualty figures differ, the demand for a transparent, independent investigation and a complete list of names remains important.',
    'এম. ইলিয়াস আলীর গুম': 'Enforced disappearance of M. Ilias Ali',
    '১৭ এপ্রিল বিএনপি নেতা এম. ইলিয়াস আলী ও তাঁর গাড়িচালক আনসার আলী নিখোঁজ হন। পরিত্যক্ত গাড়ি পাওয়া গেলেও তাঁদের সন্ধান মেলেনি; পরিবার এখনো সত্যের অপেক্ষায়।': 'On 17 April, BNP leader M. Ilias Ali and his driver Ansar Ali disappeared. Their abandoned car was found, but they remain missing; their families are still waiting for the truth.',
    '২০২৫ · আধিপত্যবাদবিরোধী সংগ্রাম': '2025 · Anti-hegemony movement',
    'শহীদ শরিফ ওসমান হাদি': 'Shaheed Sharif Osman Hadi',
    'জুলাইয়ের সংগঠক ও ইনকিলাব মঞ্চের মুখপাত্র শরিফ ওসমান হাদি ১২ ডিসেম্বর গুলিবিদ্ধ হন এবং ১৮ ডিসেম্বর চিকিৎসাধীন অবস্থায় মারা যান। তাঁর হত্যার বিচার ও রাজনৈতিক কর্মীদের নিরাপত্তা এখনো জরুরি প্রশ্ন।': 'July organiser and Inqilab Moncho spokesperson Sharif Osman Hadi was shot on 12 December and died while receiving treatment on 18 December. Justice for his killing and the safety of political activists remain urgent concerns.',
    '২৫–২৬ ফেব্রুয়ারির বিডিআর বিদ্রোহে ৭৪ জন নিহত হন—তাঁদের মধ্যে ছিলেন ৫৭ জন সেনা কর্মকর্তা। হত্যাকাণ্ড, পরবর্তী হেফাজতে মৃত্যু ও বিচারপ্রক্রিয়া নিয়ে পূর্ণ জবাবদিহির প্রশ্ন রয়ে গেছে।': 'Seventy-four people were killed in the BDR mutiny of 25–26 February, including 57 army officers. Full accountability for the killings, subsequent custodial deaths and the judicial process remains unresolved.',
    'ঘটনাটি জানুন': 'Explore the incident',
    ...
    'সার্বভৌমত্বের ইতিহাস': 'Sovereignty archive',
    'নতুন স্মৃতি-আর্কাইভ · প্রমাণসহ ইতিহাস': 'New memory archive · history with evidence',
    'চারটি নাম। চার ধরনের ক্ষত।': 'Four names. Four kinds of wound.',
    'একটি অসমাপ্ত প্রশ্ন।': 'One unfinished question.',
    'বাংলাদেশের সীমান্ত, স্বাধীন মত এবং সার্বভৌম সিদ্ধান্তের প্রশ্নে চারটি জীবনের ইতিহাস—প্রতিটি দাবি, আদালতের তথ্য ও অমীমাংসিত প্রশ্ন আলাদা করে নথিভুক্ত।': 'Four lives at the intersection of Bangladesh’s border, free expression and sovereign decisions—with every claim, court finding and unresolved question documented separately.',
    '২০১১ · সীমান্ত': '2011 · Border',
    'সে বাড়ি ফিরতে চেয়েছিল—ইতিহাস হতে নয়।': 'She was trying to return home—not to become history.',
    '২০১২ · গুম': '2012 · Disappearance',
    'একটি পরিবার প্রতিদিন নতুন করে অপেক্ষা করে।': 'A family learns to wait again every day.',
    '২০১৯ · মতপ্রকাশ': '2019 · Expression',
    'একটি পোস্ট, কয়েকটি প্রশ্ন, তারপর বন্ধ দরজা।': 'One post, a few questions, then a closed door.',
    '২০২৫ · প্রতিরোধ': '2025 · Resistance',
    'গুলি কণ্ঠ থামিয়েছে—প্রশ্ন নয়।': 'Bullets stopped a voice—not its questions.',
    'আবেগ হৃদয় খুলে দেয়। প্রমাণ সত্যকে দাঁড় করায়।': 'Emotion opens the heart. Evidence makes truth stand.',
    'মানুষের গল্প, ছবির আর্কাইভ, আদালতের রেকর্ড এবং সীমান্তে হারানো নামের দেয়াল।': 'Human stories, a visual archive, court records and a wall of names lost at the border.',
    'সম্পূর্ণ স্মৃতি-আর্কাইভে প্রবেশ করুন': 'Enter the complete memory archive',
    ...
    'July-এর সম্পূর্ণ ইতিহাস দেখুন →': 'View the complete July history →',
    ...
    'জাতীয় নাগরিক পার্টি ২৮ ফেব্রুয়ারি ২০২৫-এ আত্মপ্রকাশ করে। দলটির ঘোষিত অগ্রাধিকারের মধ্যে রাষ্ট্র ও সংবিধান সংস্কার, জবাবদিহিমূলক প্রতিষ্ঠান, বৈষম্যহীনতা এবং নাগরিকের রাজনৈতিক অংশগ্রহণ রয়েছে। দলটির ২০২৬ নির্বাচনী ইশতেহার ও গঠনতন্ত্র নিচে পড়ুন।': 'The National Citizen Party was launched on 28 February 2025. Its stated priorities include reform of the state and constitution, accountable institutions, non-discrimination and citizens’ political participation. Read the party’s 2026 election manifesto and constitution below.',
    'জাতীয় নাগরিক পার্টির নথি': 'National Citizen Party documents',
    'জাতীয় নাগরিক পার্টির ২০২৬ নির্বাচনী ইশতেহার PDF খুলুন': 'Open the National Citizen Party 2026 election manifesto PDF',
    'জাতীয় নাগরিক পার্টির গঠনতন্ত্র PDF খুলুন': 'Open the National Citizen Party constitution PDF',
    '২০২৬ নির্বাচনী ইশতেহার': '2026 election manifesto',
    'জাতীয় নাগরিক পার্টির গঠনতন্ত্র': 'National Citizen Party constitution',
    'PDF · ৮৬ পৃষ্ঠা': 'PDF · 86 pages',
    'PDF · ৩৫ পৃষ্ঠা': 'PDF · 35 pages',
    ...
    '২৮ ফেব্রুয়ারি ২০২৫': '28 February 2025',
    ...
    'ইশতেহারের অঙ্গীকার': 'Manifesto commitment',
    'রাষ্ট্র সংস্কার ও ক্ষমতার ভারসাম্য': 'State reform and checks and balances',
    'স্বাধীন প্রতিষ্ঠান, জবাবদিহি ও আইনের সমতা': 'Independent institutions, accountability and equality before the law',
    'বৈষম্যহীন নাগরিক অধিকার ও মর্যাদা': 'Equal civic rights and dignity',
    'স্থানীয় সরকারকে শক্তিশালী করা': 'Stronger local government',
    'প্রবাসীর ভোটাধিকার ও নাগরিক সেবা': 'Diaspora voting rights and civic services',
    'তরুণদের নেতৃত্বে নতুন রাজনৈতিক বন্দোবস্ত': 'A new political settlement led by young people',
  ...
  const de = {
    ...
    'স্মৃতি-যাত্রার সময়রেখা': 'Zeitleiste der Erinnerung',
    'শাসনের শুরু': 'Beginn der Herrschaft',
    'পিলখানা': 'Pilkhana',
    'ফেলানী': 'Felani',
    'ইলিয়াস': 'Ilias Ali',
    'শাপলা': 'Shapla Chattar',
    ...
    '২০০৯ · রাষ্ট্রীয় নিরাপত্তা': '2009 · Staatliche Sicherheit',
    'পিলখানা হত্যাকাণ্ড': 'Massaker von Pilkhana',
    'বিডিআর বিদ্রোহে ৭৪ জন নিহত হন, তাঁদের মধ্যে ৫৭ জন সেনা কর্মকর্তা। পূর্ণ সত্য ও জবাবদিহির প্রশ্ন আজও গুরুত্বপূর্ণ।': 'Bei der BDR-Meuterei wurden 74 Menschen getötet, darunter 57 Armeeoffiziere. Die vollständige Aufklärung und Rechenschaft bleiben weiterhin entscheidend.',
    '২০২৫ · রাজনৈতিক সহিংসতা': '2025 · Politische Gewalt',
    'ওসমান হাদী হত্যাকাণ্ড': 'Tötung von Osman Hadi',
    'তরুণ রাজনৈতিক কর্মী ওসমান হাদীর হত্যাকাণ্ড রাজনৈতিক সহিংসতা, নিরাপত্তা ও জবাবদিহির প্রশ্ন সামনে আনে।': 'Die Tötung des jungen politischen Aktivisten Osman Hadi wirft dringende Fragen zu politischer Gewalt, Sicherheit und Rechenschaft auf.',
    'ফেলানী হত্যাকাণ্ড': 'Tötung von Felani',
    'সীমান্তের কাঁটাতারে ফেলানী খাতুনের মরদেহ ঝুলে থাকা বাংলাদেশের বিবেককে নাড়া দেয়।': 'Der Anblick von Felani Khatuns Körper am Grenzzaun erschütterte das Gewissen Bangladeschs.',
    'ইলিয়াস আলী নিখোঁজ': 'Verschwinden von Ilias Ali',
    'গাড়ি পাওয়া গেল, মানুষ ফিরলেন না—গুমের অভিযোগে একটি পরিবারের অপেক্ষা আজও শেষ হয়নি।': 'Sein Auto wurde gefunden, doch er kehrte nie zurück – angesichts des Vorwurfs des gewaltsamen Verschwindenlassens wartet seine Familie bis heute.',
    '২০১৩ · রাষ্ট্রীয় অভিযান': '2013 · Staatlicher Einsatz',
    'শাপলা চত্বর': 'Shapla Chattar',
    'রাতের অভিযানের হতাহতের সংখ্যা নিয়ে মতভেদ আছে; স্বাধীন পূর্ণাঙ্গ তদন্তের দাবি রয়ে গেছে।': 'Die Angaben zu den Opfern des nächtlichen Einsatzes unterscheiden sich; die Forderung nach einer vollständigen unabhängigen Untersuchung bleibt bestehen.',
    '২০১২ · রাজনৈতিক সহিংসতা': '2012 · Politische Gewalt',
    'রাজনৈতিক সংঘর্ষের মধ্যে তরুণ দর্জি বিশ্বজিৎ দাস নিহত হন; মামলায় আদালতের দণ্ডও হয়েছিল।': 'Der junge Schneider Biswajit Das wurde während politischer Zusammenstöße getötet; Gerichte verhängten später Strafen in diesem Fall.',
    'আবরার ফাহাদ হত্যাকাণ্ড': 'Tötung von Abrar Fahad',
    'একজন শিক্ষার্থীর প্রশ্নের জবাবে দলীয় সহিংসতা—আদালতের দণ্ডের পরও ক্যাম্পাস নিরাপত্তার প্রশ্ন জাগে।': 'Auf die Fragen eines Studenten folgte parteipolitische Gewalt; trotz gerichtlicher Verurteilungen wirft der Fall weiterhin Fragen zur Sicherheit auf dem Campus auf.',
    '২০২৪ · গণঅভ্যুত্থান': '2024 · Volksaufstand',
    'ছাত্র-জনতার আন্দোলনে রাষ্ট্রীয় দমন, গুলি ও গণগ্রেপ্তারের বিরুদ্ধে মানুষ রাস্তায় দাঁড়ায়।': 'Studierende und Bürgerinnen und Bürger gingen gegen staatliche Repression, Schüsse und Massenverhaftungen auf die Straße.',
    'একটি সরকারের দীর্ঘ ছায়া; বহু মানুষের অসমাপ্ত ন্যায়বিচার।': 'Der lange Schatten einer Regierung; für viele bleibt Gerechtigkeit unvollendet.',
    'ঘটনার তারিখ, ক্ষয়ক্ষতি, তদন্তের অবস্থা, আদালতের রেকর্ড ও উৎস—সব এক জায়গায়। অনিশ্চিত দাবি আলাদা করে চিহ্নিত করা হয়েছে।': 'Daten, Verluste, Ermittlungsstand, Gerichtsakten und Quellen werden an einem Ort zusammengeführt. Unbestätigte Angaben sind klar gekennzeichnet.',
    'সম্পূর্ণ ইতিহাস দেখুন': 'Vollständige Geschichte ansehen',
    'শহীদ হাদি': 'Märtyrer Hadi',
    '২০১১ · সীমান্ত হত্যা': '2011 · Tötung an der Grenze',
    'ফেলানী খাতুন ও সীমান্ত হত্যা': 'Felani Khatun und Tötungen an der Grenze',
    '৭ জানুয়ারি ১৫ বছর বয়সী ফেলানী খাতুন বিএসএফের গুলিতে নিহত হন; কাঁটাতারে ঝুলে থাকা তাঁর মরদেহ সীমান্তে প্রাণের অধিকার ও বিচারহীনতার প্রতীক হয়ে আছে।': 'Am 7. Januar wurde die 15-jährige Felani Khatun von der indischen BSF erschossen. Ihr am Grenzzaun hängender Körper wurde zum Symbol für das Recht auf Leben und die ausbleibende Gerechtigkeit an der Grenze.',
    '২০১৯ · ক্যাম্পাস সহিংসতা': '2019 · Gewalt auf dem Campus',
    'আবরার ফাহাদ হত্যা': 'Tötung von Abrar Fahad',
    '৬ অক্টোবর বুয়েটের শিক্ষার্থী আবরার ফাহাদকে ছাত্রলীগের নেতা-কর্মীরা পিটিয়ে হত্যা করে। বিচারিক আদালত ২০ জনকে মৃত্যুদণ্ড ও ৫ জনকে যাবজ্জীবন কারাদণ্ড দেয়।': 'Am 6. Oktober wurde der BUET-Student Abrar Fahad von Funktionären und Aktivisten der Chhatra League zu Tode geprügelt. Das erstinstanzliche Gericht verurteilte 20 Angeklagte zum Tode und fünf zu lebenslanger Haft.',
    'শাপলা চত্বর অভিযান': 'Einsatz am Shapla Chattar',
    '৫–৬ মে রাতের অভিযানে বলপ্রয়োগ ও প্রাণহানির ঘটনা ঘটে। নিহতের সংখ্যা নিয়ে ভিন্ন তথ্য থাকায় স্বচ্ছ, স্বাধীন তদন্ত এবং পূর্ণাঙ্গ নামের তালিকার দাবি আজও গুরুত্বপূর্ণ।': 'Beim nächtlichen Einsatz vom 5. auf den 6. Mai kam es zu Gewaltanwendung und Todesfällen. Da die Opferzahlen voneinander abweichen, bleibt die Forderung nach einer transparenten, unabhängigen Untersuchung und einer vollständigen Namensliste wichtig.',
    'এম. ইলিয়াস আলীর গুম': 'Gewaltsames Verschwindenlassen von M. Ilias Ali',
    '১৭ এপ্রিল বিএনপি নেতা এম. ইলিয়াস আলী ও তাঁর গাড়িচালক আনসার আলী নিখোঁজ হন। পরিত্যক্ত গাড়ি পাওয়া গেলেও তাঁদের সন্ধান মেলেনি; পরিবার এখনো সত্যের অপেক্ষায়।': 'Am 17. April verschwanden der BNP-Politiker M. Ilias Ali und sein Fahrer Ansar Ali. Ihr verlassenes Auto wurde gefunden, doch von ihnen fehlt bis heute jede Spur; ihre Familien warten weiterhin auf die Wahrheit.',
    '২০২৫ · আধিপত্যবাদবিরোধী সংগ্রাম': '2025 · Kampf gegen Hegemonie',
    'শহীদ শরিফ ওসমান হাদি': 'Märtyrer Sharif Osman Hadi',
    'জুলাইয়ের সংগঠক ও ইনকিলাব মঞ্চের মুখপাত্র শরিফ ওসমান হাদি ১২ ডিসেম্বর গুলিবিদ্ধ হন এবং ১৮ ডিসেম্বর চিকিৎসাধীন অবস্থায় মারা যান। তাঁর হত্যার বিচার ও রাজনৈতিক কর্মীদের নিরাপত্তা এখনো জরুরি প্রশ্ন।': 'Der Juli-Organisator und Sprecher von Inqilab Moncho, Sharif Osman Hadi, wurde am 12. Dezember angeschossen und starb am 18. Dezember während der Behandlung. Gerechtigkeit für seine Tötung und die Sicherheit politischer Aktivisten bleiben dringende Anliegen.',
    '২৫–২৬ ফেব্রুয়ারির বিডিআর বিদ্রোহে ৭৪ জন নিহত হন—তাঁদের মধ্যে ছিলেন ৫৭ জন সেনা কর্মকর্তা। হত্যাকাণ্ড, পরবর্তী হেফাজতে মৃত্যু ও বিচারপ্রক্রিয়া নিয়ে পূর্ণ জবাবদিহির প্রশ্ন রয়ে গেছে।': 'Bei der BDR-Meuterei vom 25. bis 26. Februar wurden 74 Menschen getötet, darunter 57 Armeeoffiziere. Die vollständige Rechenschaft für die Tötungen, die anschließenden Todesfälle in Gewahrsam und das Gerichtsverfahren bleibt offen.',
    'ঘটনাটি জানুন': 'Mehr zum Ereignis',
    ...
    'সার্বভৌমত্বের ইতিহাস': 'Souveränitätsarchiv',
    'নতুন স্মৃতি-আর্কাইভ · প্রমাণসহ ইতিহাস': 'Neues Erinnerungsarchiv · Geschichte mit Belegen',
    'চারটি নাম। চার ধরনের ক্ষত।': 'Vier Namen. Vier Arten von Wunden.',
    'একটি অসমাপ্ত প্রশ্ন।': 'Eine unvollendete Frage.',
    'বাংলাদেশের সীমান্ত, স্বাধীন মত এবং সার্বভৌম সিদ্ধান্তের প্রশ্নে চারটি জীবনের ইতিহাস—প্রতিটি দাবি, আদালতের তথ্য ও অমীমাংসিত প্রশ্ন আলাদা করে নথিভুক্ত।': 'Vier Leben an der Schnittstelle von Bangladeschs Grenze, freier Meinungsäußerung und souveränen Entscheidungen—jede Behauptung, jedes Gerichtsergebnis und jede offene Frage getrennt dokumentiert.',
    '২০১১ · সীমান্ত': '2011 · Grenze',
    'সে বাড়ি ফিরতে চেয়েছিল—ইতিহাস হতে নয়।': 'Sie wollte nach Hause zurückkehren—nicht Geschichte werden.',
    '২০১২ · গুম': '2012 · Verschwinden',
    'একটি পরিবার প্রতিদিন নতুন করে অপেক্ষা করে।': 'Eine Familie lernt, jeden Tag neu zu warten.',
    '২০১৯ · মতপ্রকাশ': '2019 · Meinungsfreiheit',
    'একটি পোস্ট, কয়েকটি প্রশ্ন, তারপর বন্ধ দরজা।': 'Ein Beitrag, einige Fragen, dann eine verschlossene Tür.',
    '২০২৫ · প্রতিরোধ': '2025 · Widerstand',
    'গুলি কণ্ঠ থামিয়েছে—প্রশ্ন নয়।': 'Kugeln stoppten eine Stimme—nicht ihre Fragen.',
    'আবেগ হৃদয় খুলে দেয়। প্রমাণ সত্যকে দাঁড় করায়।': 'Emotion öffnet das Herz. Belege geben der Wahrheit Halt.',
    'মানুষের গল্প, ছবির আর্কাইভ, আদালতের রেকর্ড এবং সীমান্তে হারানো নামের দেয়াল।': 'Menschliche Geschichten, ein Bildarchiv, Gerichtsakten und eine Wand der an der Grenze verlorenen Namen.',
    'সম্পূর্ণ স্মৃতি-আর্কাইভে প্রবেশ করুন': 'Das vollständige Erinnerungsarchiv öffnen',
    ...
    'July-এর সম্পূর্ণ ইতিহাস দেখুন →': 'Die vollständige Juli-Geschichte ansehen →',
    ...
    'জাতীয় নাগরিক পার্টি ২৮ ফেব্রুয়ারি ২০২৫-এ আত্মপ্রকাশ করে। দলটির ঘোষিত অগ্রাধিকারের মধ্যে রাষ্ট্র ও সংবিধান সংস্কার, জবাবদিহিমূলক প্রতিষ্ঠান, বৈষম্যহীনতা এবং নাগরিকের রাজনৈতিক অংশগ্রহণ রয়েছে। দলটির ২০২৬ নির্বাচনী ইশতেহার ও গঠনতন্ত্র নিচে পড়ুন।': 'Die National Citizen Party wurde am 28. Februar 2025 gegründet. Zu ihren erklärten Prioritäten zählen Staats- und Verfassungsreformen, rechenschaftspflichtige Institutionen, Nichtdiskriminierung und politische Teilhabe. Lesen Sie unten das Wahlprogramm der Partei für 2026 und ihre Satzung.',
    'জাতীয় নাগরিক পার্টির নথি': 'Dokumente der National Citizen Party',
    'জাতীয় নাগরিক পার্টির ২০২৬ নির্বাচনী ইশতেহার PDF খুলুন': 'PDF des NCP-Wahlprogramms 2026 öffnen',
    'জাতীয় নাগরিক পার্টির গঠনতন্ত্র PDF খুলুন': 'PDF der NCP-Satzung öffnen',
    '২০২৬ নির্বাচনী ইশতেহার': 'Wahlprogramm 2026',
    'জাতীয় নাগরিক পার্টির গঠনতন্ত্র': 'Satzung der National Citizen Party',
    'PDF · ৮৬ পৃষ্ঠা': 'PDF · 86 Seiten',
    'PDF · ৩৫ পৃষ্ঠা': 'PDF · 35 Seiten',
    ...
    'ছাত্র-জনতার ঐতিহাসিক জাগরণ': 'Historischer Aufbruch von Studierenden und Bürgern',
    '২৮ ফেব্রুয়ারি ২০২৫': '28. Februar 2025',
    ...
    'ইশতেহারের অঙ্গীকার': 'Programmversprechen',
    'রাষ্ট্র সংস্কার ও ক্ষমতার ভারসাম্য': 'Staatsreform und Gewaltenteilung',
    'স্বাধীন প্রতিষ্ঠান, জবাবদিহি ও আইনের সমতা': 'Unabhängige Institutionen, Rechenschaft und Gleichheit vor dem Gesetz',
    'বৈষম্যহীন নাগরিক অধিকার ও মর্যাদা': 'Gleiche Bürgerrechte und Würde',
    'স্থানীয় সরকারকে শক্তিশালী করা': 'Stärkung der kommunalen Selbstverwaltung',
    'প্রবাসীর ভোটাধিকার ও নাগরিক সেবা': 'Wahlrecht und Bürgerdienste für die Diaspora',
    'তরুণদের নেতৃত্বে নতুন রাজনৈতিক বন্দোবস্ত': 'Eine neue politische Ordnung unter junger Führung',
