...
if (!html.includes('<script src="js/bootstrap.js?v=20260911-ncp-documents" defer></script>')) {
...
for (const source of ['js/i18n.js?v=20260911-ncp-documents', 'js/site.js?v=20260909-blog-arrows']) {
